...
/**
 * The [SignatureVerificationService] provides operation support for digital signature verification operations.
 */
interface SignatureVerificationService {
     ...
     * @param signature the signatureData on a message.
     ...
     */
    fun verify(publicKey: PublicKey, signature: ByteArray, clearData: ByteArray)
}